...
P_inst = 0.1								#instrumentation frequency: when Alldomain is set to true, this maybe overriden to a higher value.
...
MinRep = 3									#Only effective when Alldomain is set to true. Instead of having one representative for each domain, a minimum number of representatives are required for each domain.
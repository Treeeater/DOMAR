...
HostURL = "httpwwwnytimescom20111130technologyaproposalforeuwidedataprotec"
...
MinRep = 1									#Only effective when Alldomain is set to true. Instead of having one representative for each domain, a minimum number of representatives are required for each domain.